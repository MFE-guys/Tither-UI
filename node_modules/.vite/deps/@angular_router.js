...
UrlSerializer.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: UrlSerializer, deps: [], target: FactoryTarget.Injectable });
UrlSerializer.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: UrlSerializer, providedIn: "root", useFactory: () => new DefaultUrlSerializer() });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: UrlSerializer, decorators: [{
  type: Injectable,
...
ChildrenOutletContexts.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: ChildrenOutletContexts, deps: [], target: FactoryTarget.Injectable });
ChildrenOutletContexts.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: ChildrenOutletContexts, providedIn: "root" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: ChildrenOutletContexts, decorators: [{
  type: Injectable,
...
RouterOutlet.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterOutlet, deps: [], target: FactoryTarget.Directive });
RouterOutlet.\u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "15.0.0-next.6", type: RouterOutlet, isStandalone: true, selector: "router-outlet", inputs: { name: "name" }, outputs: { activateEvents: "activate", deactivateEvents: "deactivate", attachEvents: "attach", detachEvents: "detach" }, exportAs: ["outlet"], usesOnChanges: true, ngImport: core_exports });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterOutlet, decorators: [{
  type: Directive,
  args: [{
...
\u0275EmptyOutletComponent.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: \u0275EmptyOutletComponent, deps: [], target: FactoryTarget.Component });
\u0275EmptyOutletComponent.\u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "15.0.0-next.6", type: \u0275EmptyOutletComponent, isStandalone: true, selector: "ng-component", ngImport: core_exports, template: `<router-outlet></router-outlet>`, isInline: true, dependencies: [{ kind: "directive", type: RouterOutlet, selector: "router-outlet", inputs: ["name"], outputs: ["activate", "deactivate", "attach", "detach"], exportAs: ["outlet"] }] });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: \u0275EmptyOutletComponent, decorators: [{
  type: Component,
  args: [{
...
function namedOutletsRedirect(redirectTo) {
  return throwError(new RuntimeError(4e3, NG_DEV_MODE$6 && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
...
var ApplyRedirects = class {
  ...
  expandChildren(injector, routes, segmentGroup) {
    ...
    return from(childOutlets).pipe(concatMap((childOutlet) => {
      ...
      return this.expandSegmentGroup(injector, sortedRoutes, child, childOutlet).pipe(map((s) => ({ segment: s, outlet: childOutlet })));
  ...
  matchSegmentAgainstRoute(injector, rawSegmentGroup, route, segments, outlet) {
    if (route.path === "**") {
      ...
      if (route.loadChildren) {
        const loaded$ = route._loadedRoutes ? of({ routes: route._loadedRoutes, injector: route._loadedInjector }) : this.configLoader.loadChildren(injector, route);
...
function applyRedirects(environmentInjector, configLoader, urlSerializer, config) {
  return switchMap((t) => applyRedirects$1(environmentInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe(map((urlAfterRedirects) => Object.assign(Object.assign({}, t), { urlAfterRedirects }))));
}
...
var Recognizer = class {
  ...
  processChildren(injector, config, segmentGroup) {
    return from(Object.keys(segmentGroup.children)).pipe(concatMap((childOutlet) => {
      ...
      return children;
    }), takeWhile((children) => children !== null), defaultIfEmpty(null), last(), map((children) => {
      if (children === null)
        return null;
  ...
  processSegmentAgainstRoute(injector, route, rawSegment, segments, outlet) {
    ...
    if (route.path === "**") {
      ...
      const snapshot = new ActivatedRouteSnapshot(
        ...
        getData(route),
        getOutlet(route),
        (_b = (_a = route.component) !== null && _a !== void 0 ? _a : route._loadedComponent) !== null && _b !== void 0 ? _b : null,
        route,
...
function recognize(injector, rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return mergeMap((t) => recognize$1(injector, rootComponentType, config, t.urlAfterRedirects, serializer.serialize(t.urlAfterRedirects), serializer, paramsInheritanceStrategy, relativeLinkResolution).pipe(map((targetSnapshot) => Object.assign(Object.assign({}, t), { targetSnapshot }))));
}
...
TitleStrategy.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: TitleStrategy, deps: [], target: FactoryTarget.Injectable });
TitleStrategy.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: TitleStrategy, providedIn: "root", useFactory: () => inject(DefaultTitleStrategy) });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: TitleStrategy, decorators: [{
  type: Injectable,
...
DefaultTitleStrategy.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: DefaultTitleStrategy, deps: [{ token: Title }], target: FactoryTarget.Injectable });
DefaultTitleStrategy.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: DefaultTitleStrategy, providedIn: "root" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: DefaultTitleStrategy, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
...
var ROUTER_CONFIGURATION = new InjectionToken(NG_DEV_MODE$4 ? "router config" : "", {
  providedIn: "root",
  factory: () => ({})
});
...
RouterConfigLoader.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterConfigLoader, deps: [{ token: Injector }, { token: Compiler }], target: FactoryTarget.Injectable });
RouterConfigLoader.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterConfigLoader, providedIn: "root" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterConfigLoader, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}], ctorParameters: function() {
  return [{ type: Injector }, { type: Compiler }];
} });
        ...
        return of(overallTransitionState).pipe(
          ...
          switchMap((t) => {
            ...
            if (processCurrentUrl) {
              ...
              return of(t).pipe(
                ...
                tap((t2) => {
                  this.currentNavigation = Object.assign(Object.assign({}, this.currentNavigation), { finalUrl: t2.urlAfterRedirects });
          ...
          switchTap((t) => {
            if (t.guards.canActivateChecks.length) {
              return of(t).pipe(tap((t2) => {
                ...
                return of(t2).pipe(resolveData(this.paramsInheritanceStrategy, this.ngModule.injector), tap({
          ...
          catchError((e) => {
            ...
            if (isNavigationCancelingError$1(e)) {
              ...
              this.restoreHistory(overallTransitionState, true);
              const navError = new NavigationError(overallTransitionState.id, this.serializeUrl(overallTransitionState.extractedUrl), e, (_a = overallTransitionState.targetSnapshot) !== null && _a !== void 0 ? _a : void 0);
...
Router.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: Router, deps: "invalid", target: FactoryTarget.Injectable });
Router.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: Router, providedIn: "root", useFactory: setupRouter });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: Router, decorators: [{
  type: Injectable,
  args: [{
    providedIn: "root",
...
RouterLink.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterLink, deps: [{ token: Router }, { token: ActivatedRoute }, { token: "tabindex", attribute: true }, { token: Renderer2 }, { token: ElementRef }, { token: LocationStrategy }], target: FactoryTarget.Directive });
RouterLink.\u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "15.0.0-next.6", type: RouterLink, isStandalone: true, selector: ":not(a):not(area)[routerLink],a[routerLink],area[routerLink]", inputs: { target: "target", queryParams: "queryParams", fragment: "fragment", queryParamsHandling: "queryParamsHandling", state: "state", relativeTo: "relativeTo", preserveFragment: "preserveFragment", skipLocationChange: "skipLocationChange", replaceUrl: "replaceUrl", routerLink: "routerLink" }, host: { listeners: { "click": "onClick($event.button,$event.ctrlKey,$event.shiftKey,$event.altKey,$event.metaKey)" }, properties: { "attr.target": "this.target" } }, usesOnChanges: true, ngImport: core_exports });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterLink, decorators: [{
  type: Directive,
  args: [{
  ...
  return [{ type: Router }, { type: ActivatedRoute }, { type: void 0, decorators: [{
    type: Attribute,
    args: ["tabindex"]
  }] }, { type: Renderer2 }, { type: ElementRef }, { type: LocationStrategy }];
...
RouterLinkActive.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterLinkActive, deps: [{ token: Router }, { token: ElementRef }, { token: Renderer2 }, { token: ChangeDetectorRef }, { token: RouterLink, optional: true }], target: FactoryTarget.Directive });
RouterLinkActive.\u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "15.0.0-next.6", type: RouterLinkActive, isStandalone: true, selector: "[routerLinkActive]", inputs: { routerLinkActiveOptions: "routerLinkActiveOptions", ariaCurrentWhenActive: "ariaCurrentWhenActive", routerLinkActive: "routerLinkActive" }, outputs: { isActiveChange: "isActiveChange" }, queries: [{ propertyName: "links", predicate: RouterLink, descendants: true }], exportAs: ["routerLinkActive"], usesOnChanges: true, ngImport: core_exports });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterLinkActive, decorators: [{
  type: Directive,
  args: [{
...
PreloadAllModules.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: PreloadAllModules, deps: [], target: FactoryTarget.Injectable });
PreloadAllModules.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: PreloadAllModules, providedIn: "root" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: PreloadAllModules, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}] });
...
NoPreloading.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: NoPreloading, deps: [], target: FactoryTarget.Injectable });
NoPreloading.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: NoPreloading, providedIn: "root" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: NoPreloading, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}] });
...
RouterPreloader.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterPreloader, deps: [{ token: Router }, { token: Compiler }, { token: EnvironmentInjector }, { token: PreloadingStrategy }, { token: RouterConfigLoader }], target: FactoryTarget.Injectable });
RouterPreloader.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterPreloader, providedIn: "root" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterPreloader, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}], ctorParameters: function() {
  return [{ type: Router }, { type: Compiler }, { type: EnvironmentInjector }, { type: PreloadingStrategy }, { type: RouterConfigLoader }];
} });
...
RouterScroller.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterScroller, deps: "invalid", target: FactoryTarget.Injectable });
RouterScroller.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterScroller });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterScroller, decorators: [{
  type: Injectable
}], ctorParameters: function() {
...
var BOOTSTRAP_DONE = new InjectionToken(NG_DEV_MODE$1 ? "bootstrap done indicator" : "", {
  factory: () => {
    return new Subject();
  }
});
var INITIAL_NAVIGATION = new InjectionToken(NG_DEV_MODE$1 ? "initial navigation" : "", { providedIn: "root", factory: () => 1 });
...
var ROUTER_PRELOADER = new InjectionToken(NG_DEV_MODE$1 ? "router preloader" : "");
...
var ROUTER_FORROOT_GUARD = new InjectionToken(NG_DEV_MODE ? "router duplicate forRoot guard" : "ROUTER_FORROOT_GUARD");
...
RouterModule.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterModule, deps: [{ token: ROUTER_FORROOT_GUARD, optional: true }], target: FactoryTarget.NgModule });
RouterModule.\u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterModule, imports: [RouterOutlet, RouterLink, RouterLinkActive, \u0275EmptyOutletComponent], exports: [RouterOutlet, RouterLink, RouterLinkActive, \u0275EmptyOutletComponent] });
RouterModule.\u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterModule, imports: [\u0275EmptyOutletComponent] });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.0-next.6", ngImport: core_exports, type: RouterModule, decorators: [{
  type: NgModule,
  args: [{
...
var ROUTER_INITIALIZER = new InjectionToken(NG_DEV_MODE ? "Router Initializer" : "");
...
export {
  ...
  assignExtraOptionsToRouter as \u0275assignExtraOptionsToRouter,
  flatten as \u0275flatten,
  withPreloading as \u0275withPreloading
};
/**
 * @license
